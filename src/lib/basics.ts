...
const $defined: TypeIdentity<Defined<unknown>> = defineIdentity(describeType('defined', (v): v is Defined<unknown> => typeof v !== 'undefined'))
...
export {
  $array, $bigint, $boolean, $function, $number, $object, $string, $symbol,
  $undefined, $defined, $nil, $null, $primitive, $assignable, $any,
}
